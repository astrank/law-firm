    ...
    return (
        <div className="font-poppins">
            ...
            <main className="flex flex-col gap-8 text-primary">
                ...
                <section className="relative flex flex-col gap-4 py-36 mb-10">
                    <div className="z-10 flex flex-col gap-6 px-4 sm:px-10 md:px-14 lg:px-18 xl:px-32">
                        <div>
                            ...
                            <div>
                                <h1 className="text-white text-5xl md:text-6xl font-bold font-merriweather">Castillo-Milanesi</h1>
                        ...
                        <div className="flex gap-8">
                            <button className="bg-white text-primary text-sm font-medium px-6 py-4 rounded border-b border-dark_border self-start">CONSULTAS</button>
                ...
                {/* AREAS */}
                <section id="areas-de-actuacion" className="flex flex-col items-center gap-14 px-4 sm:px-10 md:px-14 lg:px-18 xl:px-32 mb-10">
                    <div>
                    ...
                    <div className="grid grid-flow-row lg:grid-cols-3 gap-20">
                        <div className="flex flex-col">
                            <h3 className="text-lg md:text-xl font-lora font-bold">Derecho Familiar</h3>
